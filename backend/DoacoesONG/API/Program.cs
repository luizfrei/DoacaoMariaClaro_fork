...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:3000", "https://doacao-maria-claro.vercel.app", "https://main.d2y2snun4xtyx8.amplifyapp.com","https://main.d2i6hca6f55f45.amplifyapp.com","https://main.d2ujxkja8fb6eg.amplifyapp.com") // Permite apenas o seu frontend
              .AllowAnyHeader()
              .AllowAnyMethod();
    });
});
